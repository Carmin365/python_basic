...
# Line 5 >> This line in inside the else block and will only be executed when the number is the odd. The function print, shows the text "is odd". # Esta linha está dentro do bloco else e só será executada quando o número for ímpar. A função print mostra o texto "é impar".
if number % 2 == 0:  
